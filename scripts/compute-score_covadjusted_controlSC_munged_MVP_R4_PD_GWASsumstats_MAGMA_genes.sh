...
#Compute scores for test single-cell midbrain dataset (control only) with munged_MVP_R4_PD_GWASsumstats_MAGMA_genes with covariate adjustment
...
gs_file="/home/cbb575_jy752/Final_project/scDRS/munge-genesets/munged_MVP_R4_PD_GWASsumstats_MAGMA_genes_scDRS.gs"
