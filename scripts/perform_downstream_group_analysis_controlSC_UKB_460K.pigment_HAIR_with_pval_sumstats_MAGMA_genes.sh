...
#Perform downstream group-analysis based on cell group-level annotation for single cell midbrain (control only) with UKB_460K_pigment_hair_GWASsumstats_MAGMA_genes covar-adjusted scores

h5ad_file="/home/cbb575_jy752/Final_project/Single-Cell_Datasets/controlonly_midbrain_scobject.h5ad"
score_file="/home/cbb575_jy752/Final_project/scDRS/compute-score/control_only/Hair_Pigment.full_score.gz"
